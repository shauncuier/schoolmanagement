    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-blue-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex h-16 items-center justify-between">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-xl font-bold text-slate-900 dark:text-white">SchoolSync</span>
                            ...
                            <div className="hidden items-center gap-8 md:flex">
                                <a href="#features" className="text-sm font-medium text-slate-600 transition hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400">
                                    Features
                                </a>
                                <a href="#modules" className="text-sm font-medium text-slate-600 transition hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400">
                                    Modules
                                </a>
                                <a href="#pricing" className="text-sm font-medium text-slate-600 transition hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400">
                                    Pricing
                                </a>
                                <a href="#testimonials" className="text-sm font-medium text-slate-600 transition hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400">
                                    Testimonials
                                </a>
                            </div>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
                                Streamline your school operations with our all-in-one platform. From admissions to
                                examinations, attendance to fee management – everything you need in one place.
                            </p>
                            ...
                            <div className="mt-12 flex flex-wrap items-center justify-center gap-8 opacity-60">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-slate-600 dark:text-slate-400">10,000+ Users</span>
                                </div>
                                <div className="flex items-center gap-1">
                                    {[1, 2, 3, 4, 5].map((i) => (
                                        <Star key={i} className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                                    ))}
                                    <span className="ml-2 text-sm text-slate-600 dark:text-slate-400">4.9/5 Rating</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative overflow-hidden rounded-2xl border border-slate-200/60 bg-white/80 shadow-2xl backdrop-blur dark:border-slate-700/60 dark:bg-slate-800/80">
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-4 gap-4">
                                        {[
                                            { icon: GraduationCap, label: 'Students', value: '2,546', color: 'blue' },
                                            { icon: Users, label: 'Teachers', value: '186', color: 'green' },
                                            { icon: BookOpen, label: 'Classes', value: '64', color: 'purple' },
                                            { icon: BarChart3, label: 'Attendance', value: '94.5%', color: 'orange' },
                                        ].map((stat, i) => (
                                            <div key={i} className="rounded-xl bg-slate-50 p-4 dark:bg-slate-900/50">
                                                <div className={`mb-2 inline-flex rounded-lg bg-${stat.color}-100 p-2 dark:bg-${stat.color}-900/30`}>
                                    ...
                                    <div className="mt-4 grid grid-cols-3 gap-4">
                                        <div className="col-span-2 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 p-4 text-white">
                                            ...
                                            <p className="mt-1 text-lg font-semibold">12 Classes Ongoing</p>
                                        ...
                                        <div className="rounded-xl bg-slate-50 p-4 dark:bg-slate-900/50">
                                            <p className="text-sm text-slate-500 dark:text-slate-400">Fee Collection</p>
                                            <p className="mt-1 text-lg font-bold text-slate-900 dark:text-white">$45,230</p>
                    ...
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
                                From day-to-day operations to strategic planning, we've got you covered with comprehensive tools.
                            </p>
                        </div>
                            ...
                            {[
                                {
                                    ...
                                    description: 'Complete student lifecycle management from admission to graduation with document handling.',
                                    color: 'blue',
                                },
                                {
                                    icon: Users,
                                    title: 'Staff & HR',
                                    description: 'Manage teachers, staff attendance, payroll, and performance evaluations seamlessly.',
                                    color: 'green',
                                },
                                {
                                    icon: Calendar,
                                    title: 'Smart Attendance',
                                    description: 'Multiple attendance modes including QR code, biometric integration, and manual marking.',
                                    color: 'purple',
                                },
                                {
                                    icon: BarChart3,
                                    title: 'Examinations',
                                    description: 'Create exams, manage question banks, generate report cards with flexible grading systems.',
                                    color: 'orange',
                                },
                                {
                                    icon: CreditCard,
                                    title: 'Fee Management',
                                    description: 'Flexible fee structures, online payments, installments, and automated receipt generation.',
                                    color: 'pink',
                                },
                                {
                                    icon: Bell,
                                    title: 'Communication',
                                    description: 'Send SMS, email, and push notifications. Share notices and manage events effectively.',
                                    color: 'indigo',
                                },
                            ].map((feature, i) => (
                                <div
                                ...
                                >
                                    <div className={`mb-4 inline-flex rounded-xl bg-${feature.color}-100 p-3 dark:bg-${feature.color}-900/30`}>
                                    ...
                                    <div className="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-gradient-to-br from-blue-500/10 to-indigo-500/10 opacity-0 transition-opacity group-hover:opacity-100" />
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                {/* Modules Section */}
                <section id="modules" className="bg-gradient-to-b from-slate-100 to-white py-20 lg:py-28 dark:from-slate-800/50 dark:to-slate-900">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="grid items-center gap-12 lg:grid-cols-2">
                            <div>
                                ...
                                <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
                                    Our platform covers every aspect of school management with dedicated modules for each operation.
                                </p>
                            ...
                            <div className="relative">
                                ...
                                <div className="relative grid grid-cols-2 gap-4">
                                    {[
                                        { icon: Smartphone, label: 'Mobile App', desc: 'iOS & Android' },
                                        { icon: Shield, label: 'Secure', desc: 'Bank-level security' },
                                        { icon: Globe, label: 'Multi-tenant', desc: 'Multiple schools' },
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 to-slate-800 px-8 py-16 text-center dark:from-slate-800 dark:to-slate-900 sm:px-16">
                            {/* Background Pattern */}
                            <div className="absolute inset-0 -z-10 opacity-30">
                                <div className="absolute left-0 top-0 h-full w-full bg-[radial-gradient(#ffffff33_1px,transparent_1px)] [background-size:20px_20px]" />
                            </div>
                            ...
                            <p className="mx-auto mt-4 max-w-xl text-lg text-slate-300">
                                Join thousands of schools already using SchoolSync to streamline their operations and improve outcomes.
                            </p>
                        ...
                        <div className="grid gap-8 md:grid-cols-4">
                            <div>
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-lg font-bold text-slate-900 dark:text-white">SchoolSync</span>
                                </div>
                                <p className="mt-4 text-sm text-slate-600 dark:text-slate-400">
                                    The complete school management platform trusted by institutions worldwide.
                                </p>
                            </div>
                            <div>
